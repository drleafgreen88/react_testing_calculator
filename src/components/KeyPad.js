  ...
  return (
    <div className="buttons">
        ...
        <div className="two">
          ...
          <button  data-testid="operator-divide" id="divide" onClick={() => operatorClick('/')}>/</button>
          ...
          <button data-testid="operator-multiply" id="multiply" onClick={() => operatorClick('*')}>x</button>
          ...
          <button data-testid="operator-subtract" id="subtract" onClick={() => operatorClick('-')}>-</button>
          ...
          <button data-testid="operator-equals" id="equals" onClick={() => operatorClick('=')}>=</button>
          <button data-testid="operator_add" id="add" onClick={() => operatorClick('+')}>+</button>
        </div>
        </div>
  );
}
